...
class AsyncStressTestTransport(AsyncioRequestsTransport):
...
class AsyncStressTestCheckpointStore(AsyncBlobCheckpointStore):
    """This checkpoint store is intended to be a wrapper around the async BlobCheckpointStore to allow injecting
    ...
    def __init__(
            ...
            *,
            ...
            request_patch = None,
            **kwargs) -> None:
        transport = AsyncStressTestTransport(
