...
class SecretClient(KeyVaultClientBase):
    ...
    def roll_secret(
        ...
        **kwargs: Any,
        ...
        """Create a new version of the secret with a new value. Requires secrets/set permission.

        This operation creates a new version of the specified secret. The value will be generated by the service.

        :param str name: The name of the secret to roll.
        :keyword bool enabled: Whether the new secret version is enabled for use.
        :keyword tags: Application specific metadata in the form of key-value pairs.
        :paramtype tags: Dict[str, str] or None
        :keyword str content_type: An arbitrary string indicating the type of the secret, e.g. 'password'
        :keyword ~datetime.datetime not_before: Not before date of the secret in UTC
        ...
        Example:
            .. code-block:: python
                ...
                rolled_secret = secret_client.roll_secret("secret-name")
        ...
        bundle = self._client.roll_secret(
            secret_name=name,
            parameters=parameters,
            **kwargs
        )
